...
class BillDetailTableViewController: UITableViewController, UITextFieldDelegate {
    ...
    func presentNeedAuthorizationAlert() {
        let alert = UIAlertController(
            ...
            message: "We can't set reminders for you without notification permissions. Please go to the iOS Settings app and grant us notification permissions if you wish to make use of reminders.",
